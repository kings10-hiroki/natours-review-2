...
exports.protect = catchAsync(async (req, res, next) => {
    ...
    // promisify: promiseを簡略化したもの
    // { id: '5fa0cb1792fff12b8468ceb1', iat: 1604494779, exp: 1612270779 }
    // iat:発行日時 exp:有効期限 from 1970-01-01T00:00:00Z UTC
...
exports.updatePassword = catchAsync(async (req, res, next) => {
    ...
    // passwordとpasswordConfirmの確認はどこでやるの？ => model
    // だれでもpasswordをresetするのか　protectはどうやってやるの => protect
})